    ...
    <div className="bg-biomen-bg-primary min-h-screen text-biomen-text-primary pt-[176px] md:pt-[144px]">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 pb-24 relative z-10 text-left">
        ...
        <div className="space-y-8 font-medium text-biomen-text-primary text-sm md:text-base leading-relaxed">
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">1. GENERAL DISCLAIMER</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">2. PRODUCT DISCLAIMER</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">3. INDIVIDUAL RESULTS MAY VARY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">4. TESTIMONIALS &amp; CUSTOMER EXPERIENCES</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">5. EDUCATIONAL CONTENT DISCLAIMER</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">6. TESTOSTERONE, HORMONE &amp; PERFORMANCE CONTENT DISCLAIMER</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">7. CONSULTATION DISCLAIMER</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">8. INGREDIENTS, ALLERGIES &amp; SUITABILITY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">9. NO PROFESSIONAL ADVICE</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">10. EXTERNAL LINKS &amp; THIRD-PARTY CONTENT</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">11. LIMITATION OF LIABILITY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">12. FUTURE PRODUCTS &amp; CONTENT</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">13. CHANGES TO THIS DISCLAIMER</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">14. CONTACT US</h2>
