    ...
    <div className="bg-biomen-bg-primary min-h-screen text-biomen-text-primary pt-[176px] md:pt-[144px]">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 pb-24 relative z-10 text-left">
        ...
        <div className="space-y-8 font-medium text-biomen-text-primary text-sm md:text-base leading-relaxed">
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">1. SHIPPING COVERAGE</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">2. ORDER PROCESSING</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">3. ESTIMATED DELIVERY TIMELINES</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">4. SHIPPING CHARGES</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">6. CUSTOMER RESPONSIBILITY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">7. DELIVERY ATTEMPTS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">8. DELAYS BEYOND OUR CONTROL</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">9. PROOF OF DELIVERY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">10. DAMAGED OR TAMPERED SHIPMENTS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">11. ORDER TRACKING</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">12. CHANGES TO THIS POLICY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">13. CONTACT US</h2>
