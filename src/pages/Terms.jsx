...
const Terms = () => {
  ...
  return (
    <div className="bg-biomen-bg-primary min-h-screen text-biomen-text-primary pt-[176px] md:pt-[144px]">
      <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-biomen-copper/10 rounded-full blur-[120px] pointer-events-none mix-blend-screen" />
      
      <div className="max-w-4xl mx-auto px-6 md:px-12 pb-24 relative z-10 text-left">
        {/* Back navigation */}
        <Link to="/" className="inline-flex items-center gap-2 text-biomen-text-secondary hover:text-biomen-text-primary transition-colors mb-12 font-mono font-black uppercase tracking-widest text-xs">
          <ArrowLeft size={16} /> Back to Home
        </Link>

        {/* Header */}
        <div className="border-b border-biomen-text-primary/10 pb-8 mb-12">
          <div className="inline-flex items-center gap-2 bg-biomen-copper/10 border border-biomen-copper/20 text-biomen-copper px-6 py-2 rounded-full text-xs font-black uppercase tracking-[0.2em] mb-6 shadow-md">
            <Shield size={14} /> Legal Framework
          </div>
          <h1 className="text-4xl md:text-6xl font-black tracking-tight text-biomen-text-primary uppercase mb-4">
            TERMS OF USE
          </h1>
          <p className="text-biomen-text-secondary font-mono text-xs uppercase tracking-widest">
            Last Updated: June 17, 2026
          </p>
        </div>

        {/* Content */}
        <div className="space-y-8 font-medium text-biomen-text-primary text-sm md:text-base leading-relaxed">
          <p>
          ...
          <p className="border-l-2 border-biomen-copper pl-4 italic text-biomen-text-secondary">
            If you do not agree with these Terms, you should discontinue use of the website and services immediately.
          </p>

          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">1. ELIGIBILITY</h2>
          ...
          <ul className="list-disc pl-6 space-y-2 text-biomen-text-secondary">
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">2. PRODUCTS & SERVICES</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">3. ORDERS & ACCEPTANCE</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">4. PRICING & PAYMENTS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">5. CASH ON DELIVERY (COD)</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">6. CONSULTATIONS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">7. CUSTOMER RESPONSIBILITIES</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">8. EDUCATIONAL CONTENT</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">9. USER-GENERATED CONTENT</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">10. INTELLECTUAL PROPERTY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">11. PROHIBITED USES</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">12. RIGHT TO REFUSE SERVICE</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">13. DISCLAIMER OF WARRANTIES</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">14. LIMITATION OF LIABILITY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">15. THIRD-PARTY SERVICES</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">16. GOVERNING LAW & JURISDICTION</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">17. CHANGES TO THESE TERMS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">18. CONTACT US</h2>
          <p>For questions regarding these Terms of Use, please contact:</p>
          <div className="bg-biomen-text-primary/5 border border-biomen-text-primary/10 rounded-2xl p-6 md:p-8 font-mono text-xs text-biomen-text-secondary space-y-2 mt-4 max-w-md">
            <div className="text-biomen-text-primary font-black uppercase text-sm mb-2">BIOMEN LABS</div>
