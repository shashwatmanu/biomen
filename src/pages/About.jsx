    ...
    <div className="bg-biomen-bg-primary min-h-screen text-biomen-text-primary pt-[176px] md:pt-[144px]">
      <div className="max-w-7xl mx-auto px-6 md:px-20">
        ...
        <div className="text-center mb-32">
          ...
          <p className="text-xl md:text-2xl text-biomen-text-secondary font-medium max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          <div className="aspect-square bg-gradient-to-br from-emerald-900/20 to-black rounded-[3rem] border border-biomen-text-primary/10 overflow-hidden relative group">
            <img
          ...
          <div>
            ...
            <div className="space-y-8 font-medium text-lg text-biomen-text-secondary">
              <p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          {[
            ...
            <div key={i} className="bg-biomen-text-primary/5 border border-biomen-text-primary/10 p-12 rounded-[2.5rem] hover:border-emerald-500/50 transition-all">
              <div className="w-16 h-16 bg-emerald-500/20 rounded-2xl flex items-center justify-center text-emerald-500 mb-8">
                {pillar.icon}
              </div>
              <h3 className="text-2xl font-black uppercase mb-4 text-biomen-text-primary">{pillar.title}</h3>
              <p className="text-biomen-text-secondary font-medium leading-relaxed">{pillar.desc}</p>
            </div>
          ))}
        </div>
      </div>
