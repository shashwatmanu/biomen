...
const Privacy = () => {
  ...
  return (
    <div className="bg-biomen-bg-primary min-h-screen text-biomen-text-primary pt-[176px] md:pt-[144px]">
      <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-biomen-accent/10 rounded-full blur-[120px] pointer-events-none mix-blend-screen" />
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 pb-24 relative z-10 text-left">
        ...
        <div className="border-b border-biomen-text-primary/10 pb-8 mb-12">
          <div className="inline-flex items-center gap-2 bg-biomen-accent/10 border border-biomen-accent/20 text-biomen-accent px-6 py-2 rounded-full text-xs font-black uppercase tracking-[0.2em] mb-6 shadow-md">
        ...
        <div className="space-y-8 font-medium text-biomen-text-primary text-sm md:text-base leading-relaxed">
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">1. WHO WE ARE</h2>
          <p>BIOMEN LABS is a wellness brand operated by:</p>
          <div className="bg-biomen-text-primary/5 border border-biomen-text-primary/10 rounded-xl p-4 font-mono text-xs max-w-sm">
            <div>DoubleV Labs Private Limited</div>
            <div>Plot No. 4, Ramprastha Greens, Ghaziabad</div>
            <div>Uttar Pradesh – 201010, India</div>
          </div>

          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">2. INFORMATION WE COLLECT</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">3. INFORMATION COLLECTED AUTOMATICALLY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">4. HOW WE USE YOUR INFORMATION</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">5. MARKETING COMMUNICATIONS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">6. COOKIES & TRACKING TECHNOLOGIES</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">7. ADVERTISING & ANALYTICS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">8. PAYMENT PROCESSING</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">9. INFORMATION SHARING</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">10. DATA SECURITY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">11. DATA RETENTION</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">12. YOUR RIGHTS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">13. CHILDREN'S PRIVACY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">14. THIRD-PARTY LINKS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">15. CHANGES TO THIS PRIVACY POLICY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">16. CONTACT US</h2>
