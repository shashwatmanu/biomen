    ...
    <div className="bg-biomen-bg-primary min-h-screen text-biomen-text-primary pt-[176px] md:pt-[144px]">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 pb-24 relative z-10 text-left">
        ...
        <div className="border-b border-biomen-text-primary/10 pb-8 mb-12">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-biomen-text-primary uppercase mb-4 leading-none">
            REFUND, RETURN, CANCELLATION &amp; <br className="hidden md:block" />
            <span className="text-biomen-accent">T-CORE 90-DAY PROMISE</span>
          </h1>
        ...
        <div className="space-y-8 font-medium text-biomen-text-primary text-sm md:text-base leading-relaxed">
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">1. GENERAL POLICY</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">2. DAMAGED, DEFECTIVE, INCORRECT OR TAMPERED PRODUCTS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">3. NON-RETURNABLE ITEMS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">4. ORDER CANCELLATION POLICY</h2>
          ...
          <div className="bg-biomen-surface/30 border border-[#0FA36B]/20 rounded-3xl p-6 md:p-8 space-y-6 my-12">
            <h2 className="text-2xl font-black text-biomen-text-primary uppercase tracking-wider flex items-center gap-2">
              <span className="w-2.5 h-2.5 rounded-full bg-biomen-accent animate-ping" />
              6. THE T-CORE 90-DAY PERFORMANCE PROMISE
            </h2>
            <p className="text-biomen-text-primary">
            ...
            <h3 className="text-lg font-black text-biomen-accent uppercase tracking-wider">7. ELIGIBILITY REQUIREMENTS</h3>
            <p className="text-biomen-text-secondary">To qualify for consideration under the T-Core 90-Day Performance Promise, customers must:</p>
            <ul className="list-decimal pl-6 space-y-2 text-biomen-text-secondary">
            ...
            <p className="text-xs text-biomen-text-secondary italic">Claims must be submitted within fifteen (15) calendar days following completion of the 90-day protocol. Claims submitted after this period will not be considered.</p>
          </div>

          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">8. CLAIM REVIEW PROCESS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">9. RESOLUTION OPTIONS</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">10. REFUND PROCESSING TIMELINES</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">11. THIRD-PARTY MARKETPLACE PURCHASES</h2>
          ...
          <h2 className="text-xl md:text-2xl font-black text-biomen-text-primary uppercase tracking-wider pt-4">12. CONTACT INFORMATION</h2>
