      ...
      <div className="flex lg:hidden flex-col justify-between h-[82vh] xs:h-[84vh] sm:h-[86vh] w-full max-w-xl mx-auto relative z-20 pt-4 pb-2 text-center">
        ...
        <div className="space-y-4.5 pb-2 shrink-0">
          ...
          <div className="px-2">
            <Link
              to="/products/t-core"
              className="bg-[#D85A1F] hover:bg-[#b94a17] text-white px-8 py-4.5 rounded-full font-black text-sm uppercase tracking-widest transition-all shadow-[0_0_35px_rgba(216,90,31,0.4)] flex items-center justify-center gap-2 hover:scale-[1.02] duration-300 w-full"
            >
