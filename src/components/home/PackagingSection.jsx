          ...
          <div className="lg:col-span-7 space-y-8 order-1 lg:order-2">
            ...
            <div className="pt-6 border-t border-white/10">
              ...
              <a 
                ...
                className="inline-flex items-center gap-3 bg-[#D85A1F] hover:bg-[#b94a17] text-white px-8 py-[18px] rounded-full font-black text-sm uppercase tracking-widest transition-all shadow-[0_0_25px_rgba(216,90,31,0.2)] hover:scale-[1.02] duration-300"
              >
