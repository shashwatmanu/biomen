...
const BundleSelector = () => {
  ...
  return (
    <section className="relative pt-0 pb-0 lg:pt-16 lg:pb-0 px-4 sm:px-6 md:px-20 overflow-hidden bg-[#030705] border-t border-white/5 flex flex-col justify-between" id="pricing">
