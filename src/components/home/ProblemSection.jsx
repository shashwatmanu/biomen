          ...
          <div className="lg:col-span-6 space-y-5 text-left infographic-fade-up order-2 lg:order-1">
            ...
            <div className="pt-2">
              <a 
                ...
                className="bg-[#D85A1F] hover:bg-[#b94a17] text-white px-11 py-6 rounded-full font-black text-sm uppercase tracking-widest transition-all shadow-[0_0_40px_rgba(216,90,31,0.45)] flex items-center justify-center lg:inline-flex gap-2 hover:scale-[1.03] duration-300 w-full sm:w-auto"
              >
