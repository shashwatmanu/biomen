...
const LightEmailCapture = () => {
  ...
  return (
    <section className="pt-0 pb-24 px-6 md:px-20 bg-[#060c09] border-t border-black/5 relative overflow-hidden" id="newsletter">
      ...
      <div className="max-w-4xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-5 bg-black/5 border border-black/10 p-8 rounded-[2.5rem] shadow-2xl relative">
          {status === 'success' ? (
            <div className="text-center py-6 animate-in fade-in zoom-in duration-500">
              ...
              <h3 className="text-xl font-black uppercase tracking-wider text-gray-900 mb-2">You&rsquo;re In</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="bg-emerald-500/5 p-4 rounded-xl border border-emerald-500/10 flex items-center gap-3 mb-4">
                ...
                <span className="text-[10px] text-gray-500 font-black uppercase tracking-wider leading-relaxed">
              ...
              <div className="space-y-3">
                <input 
                  ...
                  className="w-full bg-[#FCFDFD] border border-black/10 rounded-full px-6 py-4 text-gray-900 focus:outline-none focus:border-emerald-500 transition-all font-medium text-sm placeholder:text-gray-600"
                  value={email}
...
export default LightEmailCapture;
