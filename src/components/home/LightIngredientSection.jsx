...
const LightIngredientSection = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative pt-6 pb-6 lg:pt-8 lg:pb-8 px-6 md:px-20 overflow-hidden bg-[#FCFDFD] border-t border-black/5 flex flex-col justify-between"
      id="formula"
    >
      ...
      <div className="max-w-[1400px] mx-auto w-full relative z-10 flex-1 flex flex-col justify-between">
        ...
        <div className="text-center mb-6 lg:mb-2 max-w-3xl mx-auto ingredient-fade-up">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-[3.5rem] xl:text-[3.5rem] font-normal font-serif tracking-tight text-gray-900 mb-1 reveal-parent-scroll">
            <span className="block overflow-hidden relative">
              <span className="reveal-line-scroll block">The Formula, Fully Transparent</span>
            </span>
          </h2>
          <p className="text-gray-600 font-medium text-sm lg:text-base leading-relaxed">
          ...
          <div className="scale-[0.62] xs:scale-[0.72] sm:scale-[0.85] lg:scale-100 origin-center absolute flex items-center justify-center w-[480px] h-[520px]">
            ...
            >
              ...
              <div 
                ...
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[280px] h-[280px] rounded-full border border-black/10 flex flex-col justify-center items-center bg-[#FCFDFD] shadow-2xl relative z-10 backdrop-blur-md overflow-hidden cursor-grab active:cursor-grabbing"
              >
                ...
                <button
                  ...
                  className="absolute left-3.5 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-white/80 border border-black/10 flex items-center justify-center text-gray-900/50 hover:text-[#16C784] hover:bg-[#FCFDFD]/90 hover:border-[#16C784]/40 hover:scale-105 active:scale-95 transition-all duration-200 z-30 outline-none cursor-pointer"
                ...
                <button
                  ...
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-white/80 border border-black/10 flex items-center justify-center text-gray-900/50 hover:text-[#16C784] hover:bg-[#FCFDFD]/90 hover:border-[#16C784]/40 hover:scale-105 active:scale-95 transition-all duration-200 z-30 outline-none cursor-pointer"
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-1.5 z-20">
                  {ingredients.map((_, i) => (
                    <button
                      ...
                      className={`h-1 rounded-full transition-all duration-300 outline-none cursor-pointer ${activeIndex === i ? 'w-4.5 bg-[#16C784]' : 'w-1 bg-black/20 hover:bg-white/40'}`}
              ...
              <div className="absolute inset-0 w-full h-full logo-orbit-ring z-0">
                ...
                {ingredients.map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`w-20 h-20 rounded-full border-2 bg-[#FCFDFD] flex items-center justify-center transition-all duration-300 ${isNodeActive ? 'border-[#16C784] scale-110 shadow-[0_0_25px_rgba(22,199,132,0.4)]' : 'border-black/10 hover:border-black/20/40 hover:scale-105'} overflow-hidden`}>
                        <img src={item.image} alt={item.name} className="w-full h-full object-cover animate-pulse-slow" />
                      </div>
                      <span className="absolute top-[88px] left-1/2 -translate-x-1/2 text-[9px] font-black tracking-widest text-gray-600 uppercase bg-[#FCFDFD]/70 border border-black/5 px-2.5 py-0.5 rounded shadow whitespace-nowrap opacity-80 group-hover:opacity-100 transition-opacity duration-300">
                        {item.label}
                      </span>
                    </button>
                  );
        ...
        <div className="text-center mb-4 lg:mb-1.5 ingredient-fade-up">
          <a
            href="/science"
            className="inline-flex items-center gap-3 bg-[#D85A1F] hover:bg-[#b94a17] text-gray-900 px-11 py-5 rounded-full font-black text-sm uppercase tracking-widest transition-all shadow-[0_0_40px_rgba(216,90,31,0.45)] hover:scale-[1.03] duration-300 btn-sweep"
          >
            Explore T-CORE Science
          </a>
        </div>

        {/* LightFooter Trust Strip */}
        <div className="mt-2 border-t border-black/5 pt-3 flex flex-wrap justify-center gap-x-6 gap-y-2 text-[9px] font-black tracking-widest text-gray-600 uppercase ingredient-fade-up">
...
export default LightIngredientSection;
