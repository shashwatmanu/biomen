...
const PressStrip = () => {
  return (
    <div className="bg-biomen-bg-primary py-8 border-y border-biomen-text-primary/5">
      <div className="max-w-7xl mx-auto px-6">
        <p className="text-center text-xs font-bold uppercase tracking-[0.2em] text-biomen-text-secondary mb-6">Featured In & Trusted By</p>
