...
const LongTestimonials = () => {
  ...
  return (
    <section className="pt-0 pb-10 lg:pt-24 lg:pb-8 px-6 md:px-20 bg-black/40">
            ...
            <div key={i} className="glass-panel p-8 md:p-12 rounded-[2rem] border border-white/5 relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row gap-8 relative z-10">
                <div className="md:w-1/3 shrink-0">
                  <div className="flex text-[#D85A1F] mb-4">
                    {[...Array(5)].map((_, idx) => {
                      if (idx + 1 <= story.rating) {
                        return <Star key={idx} size={16} fill="currentColor" />
                      } else if (idx < story.rating) {
                        return <StarHalf key={idx} size={16} fill="currentColor" />
                      } else {
                        return <Star key={idx} size={16} fill="none" className="text-[#D85A1F]/30" />
                      }
                    })}
                  </div>
