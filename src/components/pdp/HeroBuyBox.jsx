...
const HeroBuyBox = () => {
  ...
  return (
    <>
      <section
        id="buybox"
        className={`pt-[85px] lg:pt-[140px] pb-12 lg:pb-24 px-6 md:px-20 bg-[#030705] relative overflow-hidden flex items-center ${isStickyVisible ? 'z-[60]' : 'z-10'}`}
      >
            ...
            <div className="flex flex-col lg:col-span-5 w-full gap-6">
              ...
              <div className=" w-full flex flex-col gap-6">
                ...
                <div className="relative w-full">
                  {/* Main Showcase Card */}
                  <div
                    className="aspect-square bg-gradient-to-b from-white/5 to-transparent rounded-[2rem] md:rounded-[3rem] overflow-hidden relative flex flex-col items-center justify-center border border-white/10 shadow-2xl p-0 group bg-[#06110C]/40 select-none w-[78%] md:w-full max-w-[480px] md:mx-auto"
                  >
                    ...
                    <button
                      ...
                      className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 w-8 h-8 md:w-10 md:h-10 rounded-full bg-black/60 border border-white/10 flex items-center justify-center text-white hover:bg-black hover:border-white/30 z-30 transition-all opacity-100 md:opacity-0 md:group-hover:opacity-100 cursor-pointer"
                    >
                      &larr;
                    </button>
                    <button
                      onClick={() => scrollToIdx(activeIdx === images.length - 1 ? 0 : activeIdx + 1)}
                      className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 w-8 h-8 md:w-10 md:h-10 rounded-full bg-black/60 border border-white/10 flex items-center justify-center text-white hover:bg-black hover:border-white/30 z-30 transition-all opacity-100 md:opacity-0 md:group-hover:opacity-100 cursor-pointer"
                    >
                      &rarr;
                    </button>
                  </div>
                  ...
                  <div className="absolute top-0 right-0 h-full w-[19%] md:hidden flex flex-col gap-2 overflow-y-auto snap-y snap-mandatory scrollbar-none">
                    {images.map((img, idx) => (
                      <button
                        ...
                        className={`w-full aspect-square rounded-xl border transition-all cursor-pointer overflow-hidden relative flex items-center justify-center bg-white/5 flex-shrink-0 snap-start ${activeIdx === idx ? 'border-[#0FA36B] shadow-lg bg-[#052E22]/20' : 'border-white/10'}`}
                      >
  ...
  FOUNDER BATCH RELEASE NOW LIVE
              ...
              <div className="pt-0 lg:pt-4 mt-0 lg:mt-0 lg:border-t lg:border-white/10 space-y-3 lg:space-y-4 w-full">
                      ...
                      return (
                        <div key={bundle.id} className="relative h-full flex flex-col">
                          ...
                          >
                            ...
                            <div className={`w-full h-full rounded-[14px] p-5 flex flex-col justify-between text-left relative z-10 transition-colors duration-500 overflow-hidden flex-1 ${isSelected ? 'bg-gradient-to-br from-[#052E22]/90 to-[#030705]/95' : 'bg-black/40'
                              }`}>
      ...
      <div id="pdp-sticky-bar" className={`fixed bottom-[calc(14px+env(safe-area-inset-bottom,0px))] left-1/2 -translate-x-1/2 w-[94%] max-w-4xl bg-black/85 backdrop-blur-md border border-white/10 z-[150] pl-4 pr-3 py-2.5 md:px-6 md:py-3.5 rounded-full shadow-[0_15px_45px_rgba(0,0,0,0.9)] flex items-center justify-between transition-all duration-500 ease-out ${isStickyVisible
