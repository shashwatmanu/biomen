...
const LightComparisonTable = () => {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative pt-0 lg:pt-[120px] pb-12 lg:pb-16 px-3 xs:px-4 md:px-20 overflow-hidden bg-[#FCFDFD] border-t border-black/5" 
      id="comparison"
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-[4rem] font-normal font-serif tracking-tight leading-[1.05] text-gray-900">
        ...
        <div className="bg-white/60 rounded-2xl md:rounded-3xl overflow-hidden border border-black/10 overflow-x-auto md:overflow-hidden shadow-2xl">
          <table className="w-full text-left border-collapse min-w-0">
            <thead>
              <tr className="bg-[#FCFDFD]/90 border-b border-black/10 uppercase tracking-widest text-gray-600">
                <th className="p-3 py-4 md:p-5 font-black w-[22%] md:w-[28%] text-left text-[10px] md:text-[11px] text-gray-600 tracking-widest">PARAMETER</th>
                {/* Highlighted T-CORE Column Header with Gradient Title */}
                <th className="p-3 py-4 md:p-5 text-center w-[28%] md:w-[26%] bg-[#E0F2EB]/60 border-x border-[#16C784]/20 relative">
                  <div className="flex items-center justify-center gap-2">
                    <div className="relative w-6 h-6 md:w-8 md:h-8 overflow-hidden bg-black/5 border border-black/10 rounded-full flex items-center justify-center p-0.5 shadow-md shrink-0">
                      <img 
                ...
                <th className="p-3 py-4 md:p-5 font-black text-center w-[25%] md:w-[23%] text-[10px] md:text-[11px] text-gray-900/50 tracking-widest">TRT</th>
                <th className="p-3 py-4 md:p-5 font-black text-center w-[25%] md:w-[23%] text-wrap text-[10px] md:text-[11px] text-gray-900/50 tracking-widest">GENERIC BOOSTERS</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((row, i) => (
                <tr key={i} className="border-t border-black/5 hover:bg-white/[0.02] transition-colors">
                  {/* Parameter column */}
                  <td className="p-2 py-3.5 xs:p-3 md:p-5 font-bold md:font-black text-gray-600 text-[8px] xs:text-[9px] md:text-xs tracking-wide uppercase leading-tight">{row.feature}</td>
                  
                  {/* Highlighted T-CORE Column Cells */}
                  <td className="compare-cell p-2 py-3.5 xs:p-3 md:p-5 text-center bg-[#E0F2EB]/30 border-x border-[#16C784]/20 text-gray-900 font-bold md:font-black text-[9px] xs:text-xs md:text-sm">
                    <div className="flex flex-col items-center justify-center gap-0.5 md:gap-1">
                      ...
                      <span className="text-[7.5px] xs:text-[9px] md:text-xs font-black tracking-wide text-gray-900 leading-tight">{row.us}</span>
                    </div>
                  </td>
                  ...
                  <td className={`compare-cell p-2 py-3.5 xs:p-3 md:p-5 text-center text-[9px] xs:text-xs md:text-sm ${
                    row.isTrtCheck 
                      ? "bg-[#E0F2EB]/15 border-x border-[#16C784]/10" 
                  ...
                  <td className={`compare-cell p-2 py-3.5 xs:p-3 md:p-5 text-center text-[9px] xs:text-xs md:text-sm ${
                    row.isGenericCheck 
                      ? "bg-[#E0F2EB]/10 border-x border-[#16C784]/5" 
...
export default LightComparisonTable;
