...
const FormulaOverview = () => {
  return (
    <section className="py-32 px-6 md:px-20 bg-biomen-bg-primary relative border-t border-biomen-text-primary/5">
      {/* Background patterns */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter uppercase text-biomen-text-primary">
            The 3-Step <br/> <span className="text-emerald-500">Mechanism</span>
          </h2>
          <p className="text-biomen-text-secondary text-lg md:text-xl leading-relaxed font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step) => (
            <div key={step.id} className="group relative bg-biomen-text-primary/5 rounded-[3rem] border border-biomen-text-primary/10 overflow-hidden min-h-[480px] flex flex-col justify-end p-10 hover:border-emerald-500/50 transition-all shadow-2xl">
              {/* Background Image with Overlay */}
              <div className="absolute inset-0 z-0 bg-biomen-bg-primary/40 flex items-center justify-center p-8">
              ...
              <div className="absolute top-8 left-10 text-[10rem] font-black text-biomen-text-primary/5 leading-none select-none pointer-events-none group-hover:text-emerald-500/10 transition-colors">
                {step.id}
              </div>
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-black mb-4 text-biomen-text-primary uppercase tracking-tight">
                  {step.title}
                </h3>
                <p className="text-biomen-text-primary text-sm md:text-base leading-relaxed font-medium">
                  {step.desc}
                </p>
              </div>
            </div>
